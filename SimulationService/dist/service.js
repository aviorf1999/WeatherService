...
class SimulationService {
    ...
    ;
    static buildYearlyUsedJsons(array) {
    ...
    static buildUsedWeatherDataJsons(array) {
    ...
    static buildUnusedWeatherDataJsons(array) {
        var date = new Date();
